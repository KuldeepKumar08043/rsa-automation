            ...
            <div className="row mt-5">
                <div className="col-md-6 col-lg-8">
                    <p className="copyright">
                        Copyright ©<script>document.write(new Date().getFullYear());</script>2022 All rights reserved | This template is made with 
                        <i className="ion-ios-heart" aria-hidden="true"></i> by 
                        <a href="https://colorlib.com" rel='noreference'>Colorlib.com</a>
                    </p>
                </div>
